...
class FCS_Parser(object):
    ...
    def read_text(self, file_handle):
        ...
        raw_text = file_handle.read(header['text end'] - header['text start'] )
        ...
        raw_text_segments =  raw_text[1:-1].split("\\\\")
        raw_text_segments = raw_text_segments[1:-1] # Using 1:-1 to remove first and last characters which should be reserved for delimiter
